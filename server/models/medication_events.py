...
class MedicationEvents(Base):
    ...
    admission_datetime: Mapped[Optional[DateTime]] = mapped_column("admission_datetime", DateTime)
    discharge_datetime: Mapped[Optional[DateTime]] = mapped_column("discharge_datetime", DateTime)
    ...
    dose: Mapped[Optional[float]] = mapped_column("dose", Float)
    ...
    order_start_datetime: Mapped[Optional[DateTime]] = mapped_column("order_start_datetime", DateTime)
    order_stop_datetime: Mapped[Optional[DateTime]] = mapped_column("order_stop_datetime", DateTime)
    is_prn_0_1: Mapped[Optional[int]] = mapped_column("is_prn_0_1", Integer)
    ...
    administration_datetime: Mapped[Optional[DateTime]] = mapped_column("administration_datetime", DateTime)
    administered_dose: Mapped[Optional[float]] = mapped_column("administered_dose", Float)
